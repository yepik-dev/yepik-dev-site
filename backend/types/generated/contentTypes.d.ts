...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workflow: Schema.Attribute.Component<
      'about-list-of-values.workflow',
      false
    >;
  };
}
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactItem: Schema.Attribute.Component<'contacts.contact-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMessageFromFormMessageFromForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'message_from_forms';
  info: {
    displayName: 'MessageFromForm';
    pluralName: 'message-from-forms';
    singularName: 'message-from-form';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::message-from-form.message-from-form'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::message-from-form.message-from-form': ApiMessageFromFormMessageFromForm;
