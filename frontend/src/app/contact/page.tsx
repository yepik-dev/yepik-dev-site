...
const ContactPage = ({}: contactProps) => {
  return (
    <section className="relative -mt-[60px]  z-10  min-h-[calc(100vh-430px)] px-16">
      <div className="pt-40 grid md:grid-cols-2 gap-16 h-full">
        <article>
          <h1 className="md:text-[62px] text-3xl">
            Looking for a reliable frontend developer? Let`s talk.
          </h1>
          <div className="pt-24 grid gap-y-6">
